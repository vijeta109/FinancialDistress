...
class Prediction_Data_validation:
    ...
    def valuesFromSchema(self):
        ...
        return pattern,column_names, NumberofColumns
    ...
    def moveBadFilesToArchiveBad(self):
        ...
        try:
            ...
            source = 'PredictionArchivedBadData/Bad_Raw/'
    ...
    def validateColumnLength(self,NumberofColumns):
        ...
        try:
            ...
            for file in listdir('Prediction_Raw_Files_Validated/Good_Raw/'):
                ...
                #print(df.columns)
                #print(df.info())
                data= arff.loadarff("Prediction_Raw_Files_Validated/Good_Raw/" + file)
                arff1= pd.DataFrame(data[0])
                if arff1.shape[1] == NumberofColumns:
                    pass
                else:
    ...
    def validateMissingValuesInWholeColumn(self):
        ...
        try:
            ...
            for file in listdir('Prediction_Raw_Files_Validated/Good_Raw/'):
                csv = arff.loadarff("Prediction_Raw_Files_Validated/Good_Raw/" + file)
                csv=pd.DataFrame(csv[0])
                count = 0
                for columns in csv:
                    if (len(csv[columns]) - csv[columns].count()) == len(csv[columns]):
                        ...
                        break
                if count==0:
                    csv.rename(columns={"Unnamed: 0": "class"}, inplace=True)
